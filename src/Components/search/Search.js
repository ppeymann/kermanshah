    ...
    <div className='search' >
        <div className='container'>
            <div className='left'>
                ...
                <p>تاحالا کرمانشاه رفته‌اید؟ اگر بله، برای گردش و تفریح؟ یا فقط از این شهر زیبا گذر کرده‌اید؟ به هر حال این شهر زیبا را اکثرا فقط با طاق‌بستان و بیستون می‌شناسند. اما جاهای دیدنی کرمانشاه خیلی بیشتر از این حرف‌ها هستند. کرمانشاه جاذبه‌های تاریخی، مذهبی، و طبیعی زیادی دارد که می‌تواند تعطیلات بی‌نظیری را برای شما رقم بزند.</p>
                </div>
                <div className='search-col-2'>
                <div className='box'>
                    <div>
                        <img src={flight} alt="ballon" style={{marginLeft:"1rem",width:"80px",height:"80px"}} />
                    </div>
                    <div>
                        <h3>راحتی سفر</h3>
